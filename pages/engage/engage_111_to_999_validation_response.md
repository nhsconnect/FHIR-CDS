---
title: "111/CAS (Validator) sends a response to the validation request"
...
The Validation Request Response interaction is used when a service provider wants to communicate the conclusion of a validation of a triage outcome to the Requester.
...
|---------------------------|-------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| Validated triage outcome  | 0..1  | This SHOULD  be populated with References to the following resources populated following completion of validation of triage. <br/> * Care Plan<br/>  * Encounter (validator’s) <br/>  * Referral Request <br/>  * Procedure Request <br/>  * Condition <br/>  * List <br/> * Composition <br/> * Observations <br/> * Flags  | output  |
...
| Associated referral                          | 0..1         | When the validation results in an onward referral i.e Related encounter outcome is Referral, ambulance request, or NUMSAS this MUST be a reference to the ReferralRequest for the next activity. If there is no onward referral i.e. Related encounter outcome is ’treated’ or ‘signposted’, this will not be populated.                                                                                                              | activity.Reference                       |
...
The ReferralRequest resource is used to communicate the next activity as a result of the validation.
...
| Ambulance Dispatch Breach Time               | 1..1         | Breach time calculated from the ARP category and the time of the identification of the dispatch code.                                                                                                | Occurrence (period)               |
