...
The CDSS will return a <code class="highlighter-rouge">GuidanceResponse</code> resource as the OUT parameter of the operation.
...
The returned <code class="highlighter-rouge">GuidanceResponse</code> resource will carry an appropriate code in its <code class="highlighter-rouge">status</code> element.  
