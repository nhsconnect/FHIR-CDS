...
| reason_for_request | Y | Purpose for which access is being requested | `directcare`, `secondaryuses` or `patientaccess`. This will be `directcare` in a UEC Connect implementation. | No |
| scope | N | Data being requested | This is not used in a UEC Connect implementation. See [Scopes](security_scopes.html)| No |
...
| scope | This is a space-separated list of the scopes authorised for this user. This is not used in a UEC Connect implementation. |
